...
class EarningsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post earnings_url, params: { earning: { amount: @earning.amount, category: @earning.category, description: @earning.description, title: @earning.title } }
  #   end
  ...
  #   patch earning_url(@earning), params: { earning: { amount: @earning.amount, category: @earning.category, description: @earning.description, title: @earning.title } }
